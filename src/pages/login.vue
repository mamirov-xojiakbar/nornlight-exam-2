      ...
      <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form @submit.prevent="handleLogin">
          <div class="mb-4">
            ...
            <input v-model="email" type="email" id="email" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300" required>
          </div>
...
router.push('/home'); // Login muvaffaqiyatli bo'lsa, home sahifasiga o'tish
};
</script>

<template>
    <div id="mobile" class="backdrop-blur-sm fixed w-full bottom-0 z-50 bg-white bg-opacity-60">
        <Dropdown2 v-if="dropdownVisible3" />
        <div class="grid grid-cols-5 px-2 py-2 border-t-[3px]">
            ...
            <button @click="toggleDropdown3" class="flex flex-col items-center">
...
<script setup>
import { state, toggleDropdown3 } from '../state';
import { ref, computed } from 'vue';
import Dropdown2 from './home/Dropdown2.vue';

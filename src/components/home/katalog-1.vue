<template>
  <div class="md:container mx-auto">
    ...
    >
      <swiper-slide v-for="item in items" :key="item.id" class="swiper-slide hover:shadow-xl relative grid grid-rows-1 hover:rounded-[10px]" style="height: 500px;">
...
.swiper-container {
  width: 100%; /* Ensure swiper container takes up full width */
  overflow: hidden; /* Hide any overflow to prevent extra space */
}

.swiper-slide {
  height: 470px !important; /* Adjust height as needed */
  display: flex;
...
/* Ensure no extra margin or padding on the swiper slide elements */
.swiper-slide img {
  width: 100%;
  height: auto;
  display: block;
